    ...
    <div class="flex flex-wrap lg:justify-between -mx-4">
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <p class="text-xl text-white dark:text-gray-200 leading-relaxed mb-12">
          ...
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-md text-white dark:text-gray-300">94hdzemerson@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
        <div class="text-slate-200  bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
          <form action="/contact/submit" method="POST">
            @csrf
            <div class="mb-6 text-slate-200">
              <x-forms.input placeholder="Your Name" required name="name"></x-forms.input>
              
            </div>
            <div class="mb-6 text-slate-200">
              <x-forms.input type="email" placeholder="Your Email" required name="email"></x-forms.input>
              
            </div>
            <div class="mb-6 text-slate-200">
              <x-forms.textarea placeholder="Your Message" name="message" required rows="6"></x-forms.textarea>
