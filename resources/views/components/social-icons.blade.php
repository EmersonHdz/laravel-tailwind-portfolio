    ...
    <div class=" flex items-center  ">
        <a
          href="https://www.facebook.com/legalmentemerson"
          class=" text-white hover:bg-primary hover:border-primary mr-3 flex h-12 w-12 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
          target="_blank"
        >
          <svg
            width="10"
        ...
        <a
          href="https://twitter.com/TheAlienEmerson"
          target="_blank"
          class="text-white hover:bg-primary hover:border-primary mr-3 flex h-12 w-12  items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
        >
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/emerson-sanchez-web-dev-/"
          target="_blank"
          class="text-white hover:bg-primary hover:border-primary mr-3 flex h-12 w-12  items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
        >
          <svg
